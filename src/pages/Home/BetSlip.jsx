...
const BetSlip = () => {
    return (
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-full">
            <div className="grid grid-cols-3 gap-2 px-4 w-full text-white justify-center font-bold">
              <button
                className="py-1 lg:py-2 brightness-90 overflow-hidden relative w-full text-center rounded-lg border-x-4 border-y-[1px]"
                style={{
                  color: "rgb(255, 110, 110)",
                  borderColor: "rgb(63, 63, 70)",
                  backgroundColor: "rgba(63, 63, 70, 0.565)",
                }}
              >
                2x
                <div className="h-8 w-8 lg:h-10 lg:w-10 absolute top-1/2 -translate-y-1/2 transition-all duration-[700ms] -translate-x-[150%] -rotate-180">
                  <svg
              ...
              <button
                className="py-1 lg:py-2 brightness-90 overflow-hidden relative w-full text-center rounded-lg border-x-4 border-y-[1px]"
                style={{
                  color: "rgb(69, 207, 181)",
                  borderColor: "rgb(69, 207, 181)",
                  backgroundColor: "rgba(69, 207, 181, 0.25)",
                }}
              >
                14x
                <div className="h-8 w-8 lg:h-10 lg:w-10 absolute top-1/2 -translate-y-1/2 transition-all duration-[700ms] translate-x-0">
                  <svg
                    className="p-1 w-full h-full"
                    width={194}
                    height={194}
